// ---------------------------------------------------------------------------
// AWARDS  —  /awards/  and  /zh/awards/
// Each group renders as its own column. Add or remove groups and items freely.
// ---------------------------------------------------------------------------
...
export const awards = {
  ...
  en: {
    ...
    metaTitle: 'Honours & Awards — Yijian Lu',
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          'Outstanding Paper Award, University Innovation Competition — 2024',
